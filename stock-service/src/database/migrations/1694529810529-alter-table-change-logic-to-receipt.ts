...
export class AlterTableChangeLogicToReceipt1694529810529 implements MigrationInterface {
    name = 'AlterTableChangeLogicToReceipt1694529810529'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."finish_good_status_enum" RENAME TO "finish_good_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."finish_good_status_enum" AS ENUM('COMPLETE', 'NOT_COMPLETE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."raw_material_status_enum" AS ENUM('COMPLETE', 'NOT_COMPLETE')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."raw_material_status_enum_old" AS ENUM('IN_BOUND', 'OUT_BOUND')`);
        await queryRunner.query(`ALTER TABLE "raw_material" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "raw_material" ALTER COLUMN "status" SET DEFAULT 'IN_BOUND'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."finish_good_status_enum_old" AS ENUM('IN_BOUND', 'OUT_BOUND')`);
        await queryRunner.query(`ALTER TABLE "finish_good" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "finish_good" ALTER COLUMN "status" SET DEFAULT 'IN_BOUND'`);
