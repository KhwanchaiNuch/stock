...
export class RawMaterialService {
  ...
  async createOutbound(createOutboundDto: CreateOutboundDto) {
    ...
    //   where: {
    //     areaNo: lastInboundTrx.area.areaNo,
    //   },
    // };
  ...
  async createOutboundFinal(createOutboundDto: CreateOutboundFinalsDto) {
    ...
    //   {
    //     receipt: receiptItem.id,   // RawMaterialEntity.id
    //     lotNo: lotNo,
    //     // status: TransactionStatus.HOLD2, // (ถ้าอยากให้เปลี่ยนเฉพาะที่ยังเป็น INBOUND)
    //   },
    //   {
    //     status: TransactionStatus.OUTBOUND
    //   },
  ...
  async findScanDataOutboundFinal(getOutboundDto: GetInboundV2Dto) {
