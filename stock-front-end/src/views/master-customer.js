...
const MasterCustomerView = (props) => {
    ...
    const { data, loading, onFetchQuery, refetch } = useGet('/api/v1/customer', {
        variables: {
            limit: limit,
            offset: offset
        }
    ...
    const { onDelete } = useDelete('/api/v1/customer')
            ...
            <main className="container-receipt">
                <div className="menu-top-bar">
                    <div className="container">
                        ...
                        <p className="is-active">Customer</p>
...
export default withRouter(MasterCustomerView)
