...
const MasterAreaView = (props) => {
    ...
    const { data, loading, onFetchQuery, refetch } = useGet('/api/v1/area', {
        variables: {
            limit: limit,
            offset: offset
        }
    ...
    const { onDelete } = useDelete('/api/v1/area')
            ...
            try {
                ...
                if ((selected.length - 1) === index) {
                    ...
                    showNotification({
                        props: {
                            type: 'success',
                            title: 'Delete area successfully',
                            notAutoClose: false,
                            hasCloseBtn: false
                        }
                    })
...
export default withRouter(MasterAreaView)
